...
export default function App() {
  ...
  useEffect(() => { if (sesion?.rol === "admin" && ["barbero","bcargar","bhistorial"].includes(vista)) setVista("inicio"); }, [sesion]);
  useEffect(() => { if (sesion?.rol === "barbero") { setTurnoForm(f => ({ ...f, barbero: sesion.usuario })); if (!["barbero","bcargar","bhistorial"].includes(vista)) setVista("barbero"); } }, [sesion]);
